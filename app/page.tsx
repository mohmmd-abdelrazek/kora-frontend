  ...
  return (
    <div className="flex w-full">
      <div className="flex flex-1 flex-col items-center gap-40 bg-slate-700 shadow-md max-sm:hidden">
        ...
        <ul className="flex w-full flex-col items-center justify-center gap-2 rounded-xl px-4 py-3 text-sm font-medium text-text dark:text-gray-400">
      ...
      <div className="flex h-full w-3/4 flex-col gap-8 max-sm:gap-2 bg-slate-100 max-sm:w-full">
        ...
        <div className="px-4 max-sm:py-10 sm:px-[5%] md:px-[8%] lg:pr-[30%]">
          <Section sectionId="1" team={team} />
          <Section sectionId="2" team={team} />
          <Section sectionId="3" team={team} />
        </div>
        <div className="w-full flex justify-center items-center p-4 gap-4 sm:hidden">
